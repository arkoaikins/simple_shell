...
/**
 * overall_helper - Displays all possible builtin shellby cmds.
 */
void overall_helper(void)
{
...
/**
 * alias_helper - Displays information on the shellby builtin cmd 'alias'.
 */
void alias_helper(void)
{
...
/**
 * cd_helper - Displays information on the shellby builtin cmd 'cd'.
 */
void cd_helper(void)
{
...
/**
 * exit_helper - Displays information on the shellby builtin cmd 'exit'.
 */
void exit_helper(void)
{
...
/**
 * wa_wa - Displays information on the shellby builtin cmd 'help'.
 */
void wa_wa(void)
{
